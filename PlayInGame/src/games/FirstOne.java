...
public class FirstOne extends SecondOne{
    public static void Start() {
        ...
        int botAnswer1 = random.nextInt(1, 10);
        int botAnswer2 = random.nextInt(1, 10);
        int botAnswer3 = random.nextInt(1, 10);
        while (botAnswer2 == botAnswer1) {
            botAnswer2 = random.nextInt(1, 10);
        }
        while ((botAnswer3 == botAnswer1) || (botAnswer3 == botAnswer2)) {
            botAnswer3 = random.nextInt(1, 10);
        }
